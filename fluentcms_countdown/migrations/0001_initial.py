        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default=b"dHMS",
                        help_text="y=year, o=months, w=weeks, d=days, h=hours, m=minutes, s=seconds. Uppercase means it's always visible.",
                        max_length=15,
                        verbose_name="Format",
                    ),
                ),
                (
                    "expiry_text",
                    models.CharField(
                        max_length=200, null=True, verbose_name="Expiry text", blank=True
                    ),
                ),
            ],
            options={
